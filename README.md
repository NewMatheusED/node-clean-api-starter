...
**Starter profissional em Node.js + TypeScript focado em Clean Architecture e DDD aplicados na prática.**
...
## 📘 Guia prático de Clean Architecture aplicada a APIs Node.js

Este repositório acompanha um **Guia prático** que explica **o porquê das decisões arquiteturais** e **como aplicar Clean Architecture na construção de APIs Node.js**, sempre com exemplos reais.

📌 **O guia e o starter se complementam**:

* O **guia** ensina o *porquê* e o *como pensar arquitetura*
* O **starter** mostra o *como fazer*, com código limpo e organizado
